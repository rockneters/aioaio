...
Service_SSR(){
if [[ ${OS} = "centos" ]]; then
wget --no-check-certificate https://raw.githubusercontent.com/rockneters/aioaio/main/modul/ssrmu_centos -O /etc/init.d/ssrmu
chmod +x /etc/init.d/ssrmu
chkconfig --add ssrmu
chkconfig ssrmu on
else
wget --no-check-certificate https://raw.githubusercontent.com/rockneters/aioaio/main/modul/ssrmu_debian -O /etc/init.d/ssrmu
chmod +x /etc/init.d/ssrmu
...
JQ_install(){
cd "${ssr_folder}"
wget --no-check-certificate "https://github.com/rockneters/aioaio/raw/main/modul/jq-linux64" -O ${jq_file}
chmod +x ${jq_file}
}
...
Start_SSR(){
        check_pid
        wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/rockneters/aioaio/main/ssrmu"
