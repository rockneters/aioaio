...
git clone https://github.com/rockneters/accel-ppp.git /opt/accel-ppp-code
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/rockneters/aioaio/main/modul/accel.conf"
