...
rm -r /etc/v2ray
echo "Mulai install autoscript | Mod by Rocknet VPN..."
sleep 3s
mkdir /etc/v2ray
clear
...
#Thanks to Jhrory
source <(curl -sL https://raw.githubusercontent.com/rockneters/aioaio/main/modul/v2ray.sh)
...
cd /etc/v2ray && wget https://raw.githubusercontent.com/rockneters/aioaio/main/modul/data.json
cd /etc/v2ray && wget https://raw.githubusercontent.com/rockneters/aioaio/main/modul/datatls.json
cd /etc/v2ray && wget https://raw.githubusercontent.com/rockneters/aioaio/main/modul/user.txt
cd /etc/v2ray && wget https://raw.githubusercontent.com/rockneters/aioaio/main/modul/usertrojan.txt
#Set V2ray
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/rockneters/aioaio/main/modul/acme.sh -o /root/.acme.sh/acme.sh
